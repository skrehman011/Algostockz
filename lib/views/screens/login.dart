                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 14),
                          // Distance between text and checkbox
                          Row(
                            children: [
                              CustomCheckbox(
                              ...
                              SizedBox(width: 10),
                              // Distance between checkbox and text
                              Text(
                                'Remember me',
                                style: GoogleFonts.poppins(
                                  textStyle: TextStyle(
                          ...
                          Center(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Obx(() {
                                  return Center(
                                    child: (controllerLogin.loginLoading.value)
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                setState(() {
                                  isSettingBarVisible =
                                  false; // Hide the blue color bar
                                  isContactUsBarVisible =
                                  true; // Show the Contact Us bar
                                });
                              },
                    ...
                    Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          right: 0,
                          top: 120,
                          // Start below the top 160 pixels
                          child: BlueColorBar(),
                        ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        SvgPicture.asset(
                                          ...
                                          // Replace with the path to your phone icon SVG
                                          width: 14,
                                          height: 14,
                                        ),
                                        SizedBox(width: 8),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        SvgPicture.asset(
                                          ...
                                          // Replace with the path to your mail icon SVG
                                          width: 14,
                                          height: 14,
                                        ),
                                        SizedBox(width: 8),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        SvgPicture.asset(
                                          ...
                                          // Replace with the path to your FAQs icon SVG
                                          width: 14,
                                          height: 14,
                                        ),
                                        SizedBox(width: 8),
  ...
  Widget build(BuildContext context) {
    return Container(
      height: MediaQuery
          .of(context)
          .size
          .height - 160, // Cover the entire screen except top 160 pixels
      width: double.infinity,
      decoration: BoxDecoration(
        color: Color(0xFF170044), // Background color #170044
        borderRadius: BorderRadius.only(
