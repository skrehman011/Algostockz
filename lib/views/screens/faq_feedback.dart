                                ...
                                InkWell(
                                  ...
                                  child: Center(
                                    child: Row(
                                      ...
                                      children: [
                                        SvgPicture.asset(
                                          'assets/phone.svg', // Replace with the path to your phone icon SVG
                                          width: 14,
                                          height: 14,
                                        ),
                                ...
                                InkWell(
                                  ...
                                  child: Center(
                                    child: Row(
                                      ...
                                      children: [
                                        SvgPicture.asset(
                                          'assets/mail.svg', // Replace with the path to your mail icon SVG
                                          width: 14,
                                          height: 14,
                                        ),
                                        SizedBox(width: 8), // Adjust the space between icon and text
                                ...
                                InkWell(
                                  ...
                                  child: Center(
                                    child: Row(
                                      ...
                                      children: [
                                        SvgPicture.asset(
                                          'assets/faq.svg', // Replace with the path to your FAQs icon SVG
                                          width: 14,
                                          height: 14,
                                        ),
                                        SizedBox(width: 8), // Adjust the space between icon and text
