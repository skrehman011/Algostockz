...
class LayoutDisclaimer extends StatelessWidget {
  const LayoutDisclaimer({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Disclaimer',style: TextStyle(fontSize: 26,fontWeight: FontWeight.w700,color: Colors.white),),
      ),
      backgroundColor: Color(0xFF170044),
      body:  Container(
        ...
        decoration: BoxDecoration(
          ...
          // color: Color.fromRGBO(23, 0, 68, 1).withOpacity(.5),
